...
This privacy policy applies between you, the User of this Website, and JAMA.AI LTD, the owner and provider of this Website. JAMA.AI LTD takes the privacy of your information very seriously. This privacy policy applies to our use of any and all Data collected by us or provided by you in relation to your use of the Website.
...
| Term | Definition |
| ------- | -------- |
| Data | collectively all information that you submit to JAMA.AI LTD via the Website. This definition incorporates, where applicable, the definitions provided in the Data Protection Laws; |
...
| JAMA.AI LTD, we or us | JAMA.AI LTD, a company incorporated in England and Wales with registered number 14223845 whose registered office is at 2 FREDERICK STREET, KINGS CROSS, LONDON, WC1X 0ND; |
...
| User or you | any third party that accesses the Website and is not either (i) employed by JAMA.AI LTD and acting in the course of their employment or (ii) engaged as a consultant or otherwise providing services to JAMA.AI LTD and accessing the Website in connection with the provision of such services; and |
...
3. This privacy policy applies only to the actions of JAMA.AI LTD and Users with respect to this Website. It does not extend to any websites that can be accessed from this Website including, but not limited to, any links we may provide to social media websites.

4. For purposes of the applicable Data Protection Laws, JAMA.AI LTD is the "data controller". This means that JAMA.AI LTD determines the purposes for which, and the manner in which, your Data is processed.
...
7. JAMA.AI LTD will collect your Data in a number of ways, for example:
...
27. JAMA.AI LTD may, from time to time, expand or reduce our business and this may involve the sale and/or the transfer of control of all or part of JAMA.AI LTD. Data provided by Users will, where it is relevant to any part of our business so transferred, be transferred along with that part and the new owner or newly controlling party will, under the terms of this privacy policy, be permitted to use the Data for the purposes for which it was originally supplied to us.
...
43. JAMA.AI LTD reserves the right to change this privacy policy as we may deem necessary from time to time or as may be required by law. Any changes will be immediately posted on the Website and you are deemed to have accepted the terms of the privacy policy on your first use of the Website following the alterations. 

You may contact JAMA.AI LTD by email at support{'@'}krinu.com.
