...
This privacy policy applies between you, the User of this Website, and JAMA.AI LTD DBA KRINU.COM, the owner and provider of this Website. JAMA.AI LTD DBA KRINU.COM takes the privacy of your information very seriously. This privacy policy applies to our use of any and all Data collected by us or provided by you in relation to your use of the Website.

This privacy policy should be read alongside, and in addition to, our Terms and Conditions, which can be found at: [{'https://docs.krinu.com/legal/t-and-c'}](https://docs.krinu.com/legal/t-and-c)
...
| Term | Definition |
| ------- | -------- |
| Data | collectively all information that you submit to JAMA.AI LTD DBA KRINU.COM via the Website. This definition incorporates, where applicable, the definitions provided in the Data Protection Laws; |
| Cookies | a small text file placed on your computer by this Website when you visit certain parts of the Website and/or when you use certain features of the Website. Details of the cookies used by this Website are set out in the clause below (Cookies); |
| Data Protection Laws | Definition |
| Term | any applicable law relating to the processing of personal Data, including but not limited to the GDPR, and any national implementing and supplementary laws, regulations and secondary legislation; |
| GDPR | the UK General Data Protection Regulation; |
| JAMA.AI LTD DBA KRINU.COM, we or us | JAMA.AI LTD DBA KRINU.COM, a company incorporated in England and Wales with registered number 14223845 whose registered office is at 2 FREDERICK STREET, KINGS CROSS, LONDON, WC1X 0ND; |
...
| User or you | any third party that accesses the Website and is not either (i) employed by JAMA.AI LTD DBA KRINU.COM and acting in the course of their employment or (ii) engaged as a consultant or otherwise providing services to JAMA.AI LTD DBA KRINU.COM and accessing the Website in connection with the provision of such services; and |
| Website | the website that you are currently using, [{'https://www.krinu.com'}](https://www.krinu.com), and any sub-domains of this site unless expressly excluded by their own terms and conditions. |
...
3. This privacy policy applies only to the actions of JAMA.AI LTD DBA KRINU.COM and Users with respect to this Website. It does not extend to any websites that can be accessed from this Website including, but not limited to, any links we may provide to social media websites.

4. For purposes of the applicable Data Protection Laws, JAMA.AI LTD DBA KRINU.COM is the "data controller". This means that JAMA.AI LTD DBA KRINU.COM determines the purposes for which, and the manner in which, your Data is processed.
...
7. JAMA.AI LTD DBA KRINU.COM will collect your Data in a number of ways, for example:
...
13. We may share your Data with the following groups of people for the following reasons:
	1. third party service providers who provide services to us which require the processing of personal data - to help the user's customer relationship management system log and process information on customer interactions;
...
15. Technical and organisational measures include measures to deal with any suspected data breach. If you suspect any misuse or loss or unauthorised access to your Data, please let us know immediately by contacting us via this e-mail address: support{'@'}krinu.com.
...
20. To make enquiries, exercise any of your rights set out above, or withdraw your consent to the processing of your Data (where consent is our legal basis for processing your Data), please contact us via this e-mail address: support{'@'}krinu.com.
...
27. JAMA.AI LTD DBA KRINU.COM may, from time to time, expand or reduce our business and this may involve the sale and/or the transfer of control of all or part of JAMA.AI LTD DBA KRINU.COM. Data provided by Users will, where it is relevant to any part of our business so transferred, be transferred along with that part and the new owner or newly controlling party will, under the terms of this privacy policy, be permitted to use the Data for the purposes for which it was originally supplied to us.
...
30. This Website may place and access certain Cookies on your computer.   JAMA.AI LTD DBA KRINU.COM uses Cookies to improve your experience of using the Website and to improve our range of services. JAMA.AI LTD DBA KRINU.COM has carefully chosen these Cookies and has taken steps to ensure that your privacy is protected and respected at all times.

31. All Cookies used by this Website are used in accordance with current UK and EU Cookie Law.

32. Before the Website places Cookies on your computer, you will be presented with a message bar requesting your consent to set those Cookies. By giving your consent to the placing of Cookies, you are enabling JAMA.AI LTD DBA KRINU.COM to provide a better experience and service to you. You may, if you wish, deny consent to the placing of Cookies; however certain features of the Website may not function fully or as intended.
...
43. JAMA.AI LTD DBA KRINU.COM reserves the right to change this privacy policy as we may deem necessary from time to time or as may be required by law. Any changes will be immediately posted on the Website and you are deemed to have accepted the terms of the privacy policy on your first use of the Website following the alterations. 

You may contact JAMA.AI LTD DBA KRINU.COM by email at support{'@'}krinu.com.

This privacy policy was created on 01 August 2022.
...
| Description | Purpose |
| ------- | -------- |
| User session cookie | We use this session cookie to remember you and maintain your session whilst you are using our website. |
