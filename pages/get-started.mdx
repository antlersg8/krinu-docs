...
![Sign In](../public/screenshots/Getting_started_12.png)
...
![Connect Messaging App](../public/screenshots/Gettin_started_13.png)

3. Open your messaging app and scan the QR code

![Scan QR Code](../public/screenshots/Getting_started_14.png)
...
Currently, channels can be created from HubSpot Deals. In the future, channels can be created from Companies/Accounts. 

To select a HubSpot Deal first click on the Add button, and click on `New Channel`

<Image src="/screenshots/add-channel-1.png" alt="Select Channel" width={554} height={330}/>

Select a Deal and click Save.
